          ...
          <Reveal variant="slideLeft">
            <div>
              ...
              <p className="mt-5 text-base sm:text-lg text-muted-foreground leading-relaxed">
                Hi, I'm <strong>Neha</strong>! I started The civcivgurumi out of a love for crochet
              ...
              {/* Instagram CTA */}
              <motion.a
                href="https://www.instagram.com/civcivgurumi/"
                target="_blank"
                rel="noreferrer"
              ...
              >
                ...
                Follow @civcivgurumi for daily drops →
              </motion.a>
            </div>
          </Reveal>
