          ...
          <Reveal variant="slideLeft">
            <div>
              ...
              <p className="mt-5 text-base sm:text-lg text-muted-foreground leading-relaxed">
                Hi, I'm <strong>Neha</strong>! I started The Crochet Chronicles out of a love for crochet
              ...
              {/* Instagram CTA */}
              <motion.a
                href="https://www.instagram.com/_.crochetchronicles/"
                target="_blank"
                rel="noreferrer"
              ...
              >
                ...
                Follow @_.crochetchronicles for daily drops →
              </motion.a>
            </div>
          </Reveal>
