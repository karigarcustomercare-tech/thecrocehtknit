          ...
          <Reveal variant="slideLeft">
            <div>
              ...
              <p className="mt-5 text-base sm:text-lg text-muted-foreground leading-relaxed">
                Hi, I'm <strong>Kiran</strong>! I started The Diaries Of Handmade out of a love for crochet
              ...
              {/* Instagram CTA */}
              <motion.a
                href="https://www.instagram.com/diariesofhandmade/"
                target="_blank"
                rel="noreferrer"
              ...
              >
                ...
                Follow @the.crochethouse for daily drops →
              </motion.a>
            </div>
          </Reveal>
