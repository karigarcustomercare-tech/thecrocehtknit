...
const stats = [
  ...
  { value: 223, suffix: "+",  label: "Posts & drops" },
  { value: 27000, suffix: "",   label: "Instagram followers" },
];
          ...
          <Reveal variant="slideLeft">
            <div>
              ...
              <p className="mt-5 text-base sm:text-lg text-muted-foreground leading-relaxed">
                Hi, I'm <strong>Crochet and Knots</strong>! I started The Crochet and Knots out of a love for crochet
              ...
              {/* Instagram CTA */}
              <motion.a
                href="https://www.instagram.com/Crochet and Knots/"
                target="_blank"
                rel="noreferrer"
              ...
              >
                ...
                Follow @crochet.and.knots for daily drops →
              </motion.a>
            </div>
          </Reveal>
