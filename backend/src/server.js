...
app.get("/api/health", (req, res) => {
  res.json({ success: true, message: "The Lo Crochet API is running 🧶", timestamp: new Date() });
});
...
app.listen(PORT, () => {
  console.log(`\n🧶  The Lo Crochet API running on http://localhost:${PORT}`);
