...
export function Contact() {
  ...
  const submit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setTimeout(() => {
      setSending(false);
      toast.success("Message sent! tee crochet will be in touch on WhatsApp soon 💌");
          ...
          <Reveal delay={0.1} variant="slideRight">
            <div className="flex flex-col gap-4 h-full">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  { icon: Instagram,     href: "https://www.instagram.com/tee.crochet.23/", label: "Instagram", sub: "@tee.crochet.23" },
