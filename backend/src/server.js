...
const allowedOrigins = [
  ...
  "https://crochetcorner-peach.vercel.app",
...
app.get("/api/health", (req, res) => {
  res.json({ success: true, message: "The Crochet Knit API is running 🧶", timestamp: new Date() });
});
...
app.listen(PORT, () => {
  console.log(`\n🧶  The Crochet Knit API running on http://localhost:${PORT}`);
