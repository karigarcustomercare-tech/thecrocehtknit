          ...
          <Reveal variant="slideLeft">
            <div>
              ...
              <p className="mt-5 text-base sm:text-lg text-muted-foreground leading-relaxed">
                Hi, I'm <strong>Neha</strong>! I started The tee crochet out of a love for crochet
              ...
              {/* Instagram CTA */}
              <motion.a
                href="https://www.instagram.com/tee.crochet.23/"
                target="_blank"
                rel="noreferrer"
              ...
              >
                ...
                Follow @tee.crochet.23 for daily drops →
              </motion.a>
            </div>
          </Reveal>
