          ...
          <Reveal variant="slideLeft">
            <div>
              ...
              <p className="mt-5 text-base sm:text-lg text-muted-foreground leading-relaxed">
                Hi, I'm <strong>Neha</strong>! I started The Sticth Giggles out of a love for crochet
              ...
              {/* Instagram CTA */}
              <motion.a
                href="https://www.instagram.com/stitch_giggle/"
                target="_blank"
                rel="noreferrer"
              ...
              >
                ...
                Follow @stitch_giggle for daily drops →
              </motion.a>
            </div>
          </Reveal>
